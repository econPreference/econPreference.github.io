...
This simple idea has large empirical consequences. With sign restrictions alone, the conditional correlation between output and prices remains weakly identified and centered near zero. Once we add the correlation restriction, it becomes clearly positive. Figure 1 shows how this additional restriction changes the impulse responses in an economically meaningful way. With sign restrictions alone, prices do not fall significantly after a contractionary monetary shock. With the correlation restriction, prices fall with high posterior probability, and the credible sets become visibly narrower, especially for output and prices. In short, the price puzzle disappears.
